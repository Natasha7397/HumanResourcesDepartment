 ...
 * @author Acer
 */
public class OrderPosts extends javax.swing.JDialog {

    Connection connection;
    OrderPostModel model;
     ...
     * @param c
     */
    public OrderPosts(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
        connection = c;
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        try {
            ...
            Logger.getLogger(OrderPosts.class.getName()).log(Level.SEVERE, null, ex);
        }
