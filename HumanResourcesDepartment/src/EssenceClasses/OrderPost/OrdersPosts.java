 ...
 * @author Acer
 */
public class OrdersPosts extends javax.swing.JDialog {
    private Connection connection;
    private OrderPostModel model;
    private Resize columnWidth;

    /**
     * Creates new form OrdersPosts
     */
    public OrdersPosts(java.awt.Frame parent, boolean modal, Connection c) {
        super(parent, modal);
        initComponents();
        connection = c;
        ...
        try {
            ...
            Logger.getLogger(OrdersPosts.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void modeEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modeEditActionPerformed
       try { 
           EditOrderPosts nu = new EditOrderPosts((Frame) this.getParent(), true, connection);
        nu.setVisible(true);
