 ...
 * @author Acer
 */
public class ContensOrders extends javax.swing.JDialog {
     ...
     */
    public ContensOrders(java.awt.Frame parent, boolean modal, Connection c){
        super(parent, modal);
        initComponents();
        connection = c;
        ...
        try {
            ...
            Logger.getLogger(ContensOrders.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        modeEdit.setText("Режим редоктирования");
    ...
    private void modeEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modeEditActionPerformed
       EditContenrOrders nu = new EditContenrOrders((Frame) this.getParent(), true, connection);
        nu.setVisible(true);
        try {
            model.updateData();
        } catch (SQLException ex) {
