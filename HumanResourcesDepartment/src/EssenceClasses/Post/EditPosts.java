 ...
 * @author Acer
 */
public class EditPosts extends javax.swing.JDialog {
     ...
     * @param c
     */
    public EditPosts(java.awt.Frame parent, boolean modal, Connection c) {
        super(parent, modal);
        initComponents();
        connection = c;
    ...
    private void editPostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editPostActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            NewPost nu = new NewPost((Frame) this.getParent(), true,
                    connection, model.getSelectesPost(jTable1.getSelectedRow()));
            nu.setVisible(true);
            try {
                model.updateData();
            } catch (SQLException ex) {
    ...
    private void deletePostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletePostActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            try {
                model.delete(
                        model.getSelectesPost(jTable1.getSelectedRow()).getId());
